...
public class GitlabAPI {
    ...
    public GitlabProject getProject(Integer projectId) throws IOException {
        ...
        GitlabProject project = retrieve().to(tailUrl, GitlabProject.class);
        project.setRequestor(retrieve());
        project.setCurrentTailUrl(tailUrl);
        return project;
    }

    public List<GitlabProject> getProjects() throws IOException {
        String tailUrl = GitlabProject.URL;
        List<GitlabProject> projects = retrieve().getAll(tailUrl, GitlabProject[].class);
